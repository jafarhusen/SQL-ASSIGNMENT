...
This repository folder contains the execution artifacts and architectural reflections for Session 1 assignments.
...
* **Task 1:** System verified via active running instances.
* **Task 2:** Created `music_streaming_db` schema.
* **Task 3:** Created `food_delivery_db` schema via the `CREATE DATABASE` statement.
